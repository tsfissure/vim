...
copy D:\EditMachine\Vim\vim80\indent\tysformatter.vim .\indent\
copy D:\EditMachine\Vim\vim80\indent\tyssetting.vim .\indent\
copy D:\EditMachine\Vim\vim80\colors\delek-tys.vim .\color\delek-tys.vim
